...
"""
   The client port number is my port id on which we listen for connections the server
port number to which the connection request is sent. It varies from server to server

--> implement theads to connect to different fog servers
"""
